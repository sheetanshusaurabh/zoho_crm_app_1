...
public class PdfGenerator {
    ...
    public void generatePDF(Billing billing, String filePath) {
        try {
            ...
            addTitleAndTable(document, billing.getFirstName(), billing.getEmail(), billing.getMobile(), billing.getLastName(), billing.getProduct() ,billing.getAmount(), filePath);
            document.close();
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private static void addTitleAndTable(Document document, String name, String emailId, String phone, String operatingAirlines, String departureDate, String departureCity, String arrivalCity)
        ...
        PdfPCell c1 = new PdfPCell(new Phrase("customer Detail"));
        ...
        PdfPCell c2 = new PdfPCell(new Phrase("product details"));
